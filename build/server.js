...
(function() {
  var CHECK_INTERVAL, RELEASE_INTERVAL, argv, data, decode, denied, dispatcher, getHandler, http, https, isSecure, jade, logger, message, mime, options, pool, postHandler, respond, retry, server, url, uuid, winston, zlib,
  ...
  getHandler = function(info, req, res) {
    var host, item, path, preferHost, redirectUrl;
