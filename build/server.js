...
(function() {
  var CHECK_INTERVAL, RELEASE_INTERVAL, argv, data, decode, denied, dispatcher, getHandler, http, jade, message, mime, pool, postHandler, respond, retry, server, url, uuid, zlib,
  ...
  decode = function(buff) {
    ...
    data = newData;
    return console.log('[' + (new Date().toISOString()) + '] publish success');
  };
  ...
  module.exports = function() {
    ...
    return console.log("Listening on " + argv.h + ":" + argv.p);
  };
